package com.cloudmotiv.gs_demo_vishal;
...
public class GSDemoVishalActivity extends FragmentActivity implements View.OnClickListener, OnMapReadyCallback {

    private static final String TAG = GSDemoVishalActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gs_demo_vishal);
    ...
    public void onReturnGsDemo(View view) {
        Log.e(TAG, "onReturn");
        this.finish();
    }
        ...
        UserAccountManager.getInstance().logIntoDJIUserAccount(this,
                new CommonCallbacks.CompletionCallbackWith<UserAccountState>() {
                    ...
                    public void onSuccess(final UserAccountState userAccountState) {
                        ...
                        GSDemoVishalActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
    ...
    private void updateTitleBar() {
        ...
        if (product != null) {
            if (product.isConnected()) {
                ...
                GSDemoVishalActivity.this.runOnUiThread(new Runnable() {
                    public void run() {
                        mConnectStatusTextView.setText(DemoApplication.getProductInstance().getModel() + " Connected");
                    }
                });
                ret = true;
            } else {
    ...
    public void showToast(final String msg) {
        GSDemoVishalActivity.this.runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(GSDemoVishalActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            case R.id.geo_get_custom_unlock_zones:
                DJISDKManager.getInstance().getFlyZoneManager().getCustomUnlockZonesFromAircraft(new CommonCallbacks.CompletionCallbackWith<List<CustomUnlockZone>>() {
                    ...
                    public void onSuccess(final List<CustomUnlockZone> customUnlockZones) {
                        ...
                        GSDemoVishalActivity.this.customUnlockZones = (ArrayList<CustomUnlockZone>) customUnlockZones;
